...
class TestBroadcastFunctionUsesHardChannel:
    ...
    def test_broadcast_uses_channel_hard_not_legacy(self, monkeypatch):
        ...
        monkeypatch.setattr(_bot, "TELEGRAM_CHANNEL_ID_HARD", -100111111111)
        monkeypatch.setattr(_bot, "TELEGRAM_CHANNEL_ID", -100999999999)
        ...
        assert -100111111111 in sent_to
        assert -100999999999 not in sent_to
    ...
    def test_broadcast_falls_back_to_legacy_when_hard_is_zero(self, monkeypatch):
        ...
        assert -100999999999 in sent_to
...
class TestSignalRouterChannels:
    ...
    def test_spot_channel_routes_to_ch4(self):
        ...
        assert router.get_channel_id(ChannelTier.SPOT) == -100444
    ...
    def test_insights_channel_routes_to_ch5(self):
        ...
        assert router.get_channel_id(ChannelTier.INSIGHTS) == -100555
