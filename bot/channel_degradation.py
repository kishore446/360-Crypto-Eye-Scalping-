...
try:
    ...
    CHANNEL_DEGRADATION_LOW_WR: float = 35.0          # Raise confluence threshold below this WR
    CHANNEL_DEGRADATION_SUPPRESS_WR: float = 25.0     # Suppress channel entirely below this WR
    CHANNEL_DEGRADATION_RECOVERY_WR: float = 50.0     # Auto-restore when WR recovers above this
    CHANNEL_DEGRADATION_EXTRA_CONFLUENCE: int = 15    # Extra confluence points required when degraded
